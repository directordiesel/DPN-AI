...
def test_windows_build_script_has_single_complete_update_trust_validation():
    assert BUILD_SCRIPT.count("Invoke-Checked $Python -m PyInstaller") == 1
    assert "Update trust root schema version is invalid." in BUILD_SCRIPT
