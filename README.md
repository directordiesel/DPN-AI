...
<p align="center">
  ...
  <img alt="Maintenance Candidate" src="https://img.shields.io/badge/Candidate-v10.0.1-7c3aed?style=for-the-badge">
  <img alt="Release" src="https://img.shields.io/badge/Release-v10.0.0--Published-16a34a?style=for-the-badge">
...
<p align="center">
  ...
  <strong>Maintenance candidate:</strong> v10.0.1 &nbsp;•&nbsp;
...
DPN AI **v10.0.0** is the published stable release. **v10.0.1** is the current maintenance candidate focused on interface sanitation, accessibility, mobile reachability, actionable recovery guidance, version coherence, and fail-closed maintenance release validation. The candidate is not published merely because its repository metadata is promoted.

| Release resource | Published v10.0.0 |
| --- | --- |
| GitHub Release | [DPN AI v10.0.0](https://github.com/directordiesel/DPN-AI/releases/tag/v10.0.0) |
| Source archive | [`DPN-AI-v10.0.0-source.zip`](https://github.com/directordiesel/DPN-AI/releases/download/v10.0.0/DPN-AI-v10.0.0-source.zip) |
| SHA-256 checksum | [`SHA256SUMS.txt`](https://github.com/directordiesel/DPN-AI/releases/download/v10.0.0/SHA256SUMS.txt) |
| Release manifest | [`RELEASE_MANIFEST.txt`](https://github.com/directordiesel/DPN-AI/releases/download/v10.0.0/RELEASE_MANIFEST.txt) |
| SPDX SBOM | [`SBOM.spdx.json`](https://github.com/directordiesel/DPN-AI/releases/download/v10.0.0/SBOM.spdx.json) |
| Source integrity manifest | [`SOURCE_SHA256SUMS.txt`](https://github.com/directordiesel/DPN-AI/releases/download/v10.0.0/SOURCE_SHA256SUMS.txt) |
| Dependency inventory | [`DEPENDENCY_INVENTORY.txt`](https://github.com/directordiesel/DPN-AI/releases/download/v10.0.0/DEPENDENCY_INVENTORY.txt) |

Release artifacts are generated by the controlled GitHub Actions release pipeline after version checks, repository-state checks, tests, SBOM generation, source hashing, and release validation. Publishing v10.0.1 remains a separate manual action from `main` after exact-head acceptance.

## v10 Platform at a Glance
...
| Desktop | Black/purple Control Center, command palette, live status cards, approvals/tasks, and accessibility improvements |
...
For historical pre-v10 provider/runtime state, see [`docs/V9_CAPABILITY_MATRIX.md`](docs/V9_CAPABILITY_MATRIX.md). Current v10 capability claims are governed by runtime diagnostics, tests, and the v10 release-readiness evidence.
...
The v10 intelligence runtime provides deterministic planner/executor/reviewer orchestration with explicit task dependencies and mission state. Work can be decomposed into ordered steps, retried within bounded policies, blocked when required evidence is missing, and summarized with explicit progress state.
...
DPN AI v10 can combine project context, long-term memory, semantic retrieval, indexed sources, and conversation state. The retrieval architecture is designed to keep sourced evidence distinguishable from model assumptions.
...
v10 includes provider routing, validation, workspace containment, capability discovery, and fail-closed execution for image editing and vision analysis. **Editing and vision require a configured provider implementation.** DPN AI does not report those operations as live when a capable provider is absent.
...
Automation in v10 is more than a simple timer. The architecture includes:
...
The v10 desktop experience extends the DPN black/purple interface with:
...
External integrations are treated as governed operations. v10 includes connector/MCP classification for inspect/read/write/delete/sync/execute operations, including requirements for:
...
DPN AI v10 includes recovery and operational-readiness foundations around:
...
- resource management
- Ed25519 public-key update manifest verification
...
The v10 evaluation suite provides weighted production-readiness decisions. Critical failures, skipped critical evaluations, and missing critical evidence fail closed.

Evaluation coverage includes security, permission boundaries, prompt injection, network policy, secret handling, integration safety, release readiness, and regression cases across the v10 architecture.
...
| Release status | **v10.0.0 published; v10.0.1 validation in progress** |
| Development direction | **v10.0.x reliability, usability, security, and release hardening** |
...
| Historical capability matrix | [`docs/V9_CAPABILITY_MATRIX.md`](docs/V9_CAPABILITY_MATRIX.md) |
| Roadmap | [`ROADMAP.md`](ROADMAP.md) |
| Changelog | [`CHANGELOG.md`](CHANGELOG.md) |

## v10.0.x Maintenance Direction

Post-v10.0.0 development is focused on improving the published v10 architecture rather than replacing it. v10.0.1 prioritizes understandable UI, reliable desktop/mobile interaction, actionable failure recovery, accessibility, version coherence, and exact-head maintenance release evidence. Later v10.0.x work can continue deeper reliability, coding intelligence, permission consistency, memory/RAG quality, research verification, artifact quality, provider integrations, voice robustness, model benchmarking/routing, vault/audit hardening, performance, recovery, SDK/integrations, evaluations, installer/release engineering, and capability-state reporting.
...
- [`docs/V10_0_1_MAINTENANCE_RELEASE_READINESS.md`](docs/V10_0_1_MAINTENANCE_RELEASE_READINESS.md)
- [`docs/V9_CAPABILITY_MATRIX.md`](docs/V9_CAPABILITY_MATRIX.md) — historical pre-v10 matrix
